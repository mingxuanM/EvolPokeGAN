...
experiment_name = 'PokeGAN_experiment'
...
print(experiment_folder, experiment_logs, experiment_saved_models, experiment_outputs)
...
if not os.path.exists(experiment_outputs):
    os.mkdir(experiment_outputs)  # create the experiment log directory

if not os.path.exists(experiment_saved_models):
